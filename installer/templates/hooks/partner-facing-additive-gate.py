...
partner-facing repos (Usd8-fi, [REDACTED-NDA]-internal). Forces a review prompt via
...
PARTNER_REPO_PATTERNS = [
    ...
    r"github\.com[:/]+[REDACTED-NDA]/",
    r"github\.com[:/]+[REDACTED-NDA]/",
    r"github\.com[:/]+[REDACTED-NDA]-internal/",
]
...
RETROSPECTIVE_PATTERNS = [
    ...
    (r"\bbased\s+on\s+(?:rick'?s|[REDACTED-NDA]'?s|the)\s+feedback\b", "based on (rick/[REDACTED-NDA]/the) feedback"),
