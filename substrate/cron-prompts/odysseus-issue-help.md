...
2. Auto-post the **top decile** (ceil(0.10 × |resolvable-by-us|)) AND only those whose confidence ≥ 0.85 absolute. The 10% is a cap, not a quota — if fewer clear the 0.85 floor, post fewer. Zero clearing the floor ⇒ post zero (correct outcome, not failure).
...
4. **Pace:** ≤ 2 auto-posts per fire. Never batch-fire. Human-plausible cadence is part of genuine-not-bot.
