...
Blocks writes to external-audience artifacts ([REDACTED-NDA]_Reports, [REDACTED-NDA]_RnD, any
Desktop .md naming [REDACTED-NDA]/[REDACTED-NDA]) when the content contains strategic-framing
language that was intended strictly between Will and Jarvis.

Prevents the 2026-04-21 near-miss where today's [REDACTED-NDA] daily report almost
shipped with a quote of the private strategic framing ("[REDACTED-NDA] is 99%
[REDACTED-NDA]-focused ... cleverly make everything useful to him"). Will caught it
...
EXTERNAL_PATH_PATTERNS = [
    r"[/\\]Desktop[/\\][REDACTED-NDA]_Reports[/\\]",
    r"[/\\]Desktop[/\\][REDACTED-NDA]_RnD[/\\]",
    # Any .md/.txt/.html/.pdf on Desktop whose filename mentions [REDACTED-NDA]/[REDACTED-NDA]
    r"[/\\]Desktop[/\\][^/\\]*(?:[REDACTED-NDA]|[REDACTED-NDA]|[REDACTED-NDA])[^/\\]*\.(md|txt|html|pdf)$",
    # Drafts folder (emails, etc.)
    r"[/\\]Desktop[/\\][^/\\]*drafts?[^/\\]*[/\\].*(?:[REDACTED-NDA]|[REDACTED-NDA])",
]
...
LEAK_PATTERNS = [
    ...
    (
        r"\b\d{1,3}\s*%\s*(?:focused|[REDACTED-NDA]-focused|attention|attention-focused|focus)",
...
def main() -> None:
    ...
    lines = [
        ...
        f"",
        f"File: {file_path}",
        f"This path writes to an external-audience artifact ([REDACTED-NDA]_Reports / [REDACTED-NDA]_RnD / Desktop artifact matching [REDACTED-NDA]/[REDACTED-NDA]).",
        f"",
    ...
    lines.append(
        ...
        "They must not appear in artifacts sent to external audiences ([REDACTED-NDA] / [REDACTED-NDA] collaborators / public)."
    )
    lines.append("")
    lines.append(
