...
def main() -> int:
    ...
    # Stop event does NOT support hookSpecificOutput.additionalContext (schema rejects).
    # Logging is the load-bearing behavior; the transparency notice was dev-only.
    print(json.dumps({}))
    return 0
